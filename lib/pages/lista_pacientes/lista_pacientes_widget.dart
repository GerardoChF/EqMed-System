...
import 'lista_pacientes_model.dart';
export 'lista_pacientes_model.dart';

class ListaPacientesWidget extends StatefulWidget {
  const ListaPacientesWidget({super.key});

  @override
  State<ListaPacientesWidget> createState() => _ListaPacientesWidgetState();
}

class _ListaPacientesWidgetState extends State<ListaPacientesWidget> {
  late ListaPacientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaPacientesModel());
  }
