...
import 'login_u_model.dart';
export 'login_u_model.dart';

class LoginUWidget extends StatefulWidget {
  const LoginUWidget({super.key});

  @override
  State<LoginUWidget> createState() => _LoginUWidgetState();
}

class _LoginUWidgetState extends State<LoginUWidget>
    with TickerProviderStateMixin {
  late LoginUModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginUModel());
    ...
    _model.lNameCreateTextController ??= TextEditingController();
    _model.lNameCreateFocusNode ??= FocusNode();
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    cursorColor:
                                                        FlutterFlowTheme.of(
                                                            ...
                                                            .primary,
                                                    validator: _model
                                                        .txtLnameTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .lNameCreateTextController,
                                                      focusNode: _model
                                                          .lNameCreateFocusNode,
                                                      autofocus: true,
                                                      autofillHints: [
                                                        AutofillHints.email
                                                      ],
                                                      ...
                                                      cursorColor:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .primary,
                                                      validator: _model
                                                          .lNameCreateTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
